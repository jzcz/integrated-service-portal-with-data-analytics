...
<?php
  ...
  <?php
    ...
    ?>
  <form method="POST" action="../../queries/process-gmcr.php" enctype="multipart/form-data" target="_self">
    <div class="form-header-container">
      <h1 class="p-5"> Good Moral Certificate<br>Request Form </h1>
    </div>
      ...
      <div class="mb-3 specify-reason-row">
        ...
        <textarea class="form-control" id="specifyReason" name="specifyReason" rows="3" placeholder="Specify reason"></textarea>
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="proofOfImage" name="proofOfImage" accept="image/*" required>
